...
M_FEATURE_SET_DIR=../../bin/utils/timit_map/omfile.pickle
# Path to the place set 
P_FEATURE_SET_DIR=../../bin/utils/timit_map/opfile.pickle
# Path to the high set 
H_FEATURE_SET_DIR=../../bin/utils/timit_map/ohfile.pickle
# Path to the front set 
F_FEATURE_SET_DIR=../../bin/utils/timit_map/offile.pickle
# Path to the round set
R_FEATURE_SET_DIR=../../bin/utils/timit_map/orfile.pickle
# Path to the static set 
S_FEATURE_SET_DIR=../../bin/utils/timit_map/osfile.pickle
