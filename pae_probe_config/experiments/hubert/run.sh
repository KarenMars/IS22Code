...
MODEL=/tudelft.net/staff-bulk/ewi/insy/SpeechLab/hangji/open_source_ckpt/huggingface/hubert-base
...
#         echo "Extracting hubert features for ${corpus}..."
#         export CUDA_VISIBLE_DEVICES=1
#         gen_hubert_feats.py \
#             --use_gpu \
#             --disable-progress \
# 	        --hubert \
# 	        $MODEL $FEATS_DIR/$corpus/${MODEL_NAME} \
...
if [ $stage -le 1 ]; then
    ...
    gen_config_files.py \
	--step 0.020 \
        $FEATS_DIR hubert-base-ls960 configs/tasks $DATA_DIR
fi
