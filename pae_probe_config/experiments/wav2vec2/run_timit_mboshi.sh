...
if [ $stage -le 1 ]; then
    ...
    gen_config_files.py \
    --step 0.020 \
        $FEATS_DIR wav2vec2-base-ls960 configs/tasks $timit_DATA_DIR $mboshi_DATA_DIR 'timit' 'mboshi'
fi
    ...
    for config in `ls configs/tasks/*.yaml`; do
        ...
        then
            ...
            ../../bin/svm_cross/exp_front_ova.py \
                --n-jobs $nj $config $timit_F_FEATURE_SET_DIR $mboshi_F_FEATURE_SET_DIR ${Train_LANG}_${Test_LANG} 'timit' 'mboshi' \
        ...
        then
            ...
            ../../bin/svm_cross/exp_voice_ova.py \
                --n-jobs $nj $config $timit_V_FEATURE_SET_DIR $mboshi_V_FEATURE_SET_DIR ${Train_LANG}_${Test_LANG} 'timit' 'mboshi' \
        ...
        then
            ...
            ../../bin/svm_cross/exp_manner_ova.py \
                --n-jobs $nj $config $timit_M_FEATURE_SET_DIR $mboshi_M_FEATURE_SET_DIR ${Train_LANG}_${Test_LANG} 'timit' 'mboshi' \
        ...
        then
            ...
            ../../bin/svm_cross/exp_place_ova.py \
                --n-jobs $nj $config $timit_P_FEATURE_SET_DIR $mboshi_P_FEATURE_SET_DIR ${Train_LANG}_${Test_LANG} 'timit' 'mboshi' \
        ...
        then
            ...
            ../../bin/svm_cross/exp_high_ova.py \
                --n-jobs $nj $config $timit_H_FEATURE_SET_DIR $mboshi_H_FEATURE_SET_DIR ${Train_LANG}_${Test_LANG} 'timit' 'mboshi' \
        ...
        then 
            ...
            ../../bin/svm_cross/exp_round_ova.py \
                --n-jobs $nj $config $timit_R_FEATURE_SET_DIR $mboshi_R_FEATURE_SET_DIR ${Train_LANG}_${Test_LANG} 'timit' 'mboshi' \
        ...
        then 
            ...
            ../../bin/svm_cross/exp_static_ova.py \
                --n-jobs $nj $config $timit_S_FEATURE_SET_DIR $mboshi_S_FEATURE_SET_DIR ${Train_LANG}_${Test_LANG} 'timit' 'mboshi' \
